...
namespace SnackBarSupport.Controllers
{
    ...
    public class IngredientsControllerOld : ApiController
    {
        public MongoDbContext Context { get; set; }

        public IngredientsControllerOld() : this(new MongoDbContext())
        { }

        public IngredientsControllerOld(MongoDbContext context)
        {
            Context = context;
        }
