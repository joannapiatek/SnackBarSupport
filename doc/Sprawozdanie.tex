...
\newpage
\input{./chapters/Analiza_Wymagan}
\newpage
\input{./chapters/Implementacja_Bazy}
\newpage
\input{./chapters/Implementacja_Aplikacji}
\newpage
\input{./chapters/Wdrozenie_Testy}
\newpage
\input{./chapters/Podsumowaie}
%\newpage
